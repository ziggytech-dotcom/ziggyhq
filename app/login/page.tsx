        ...
        <div className="bg-[#1a1a1a] border border-[#2d2d2d] rounded-xl p-8">
          {sent ? (
            <div className="text-center">
              ...
              <button onClick={() => setSent(false)} className="mt-6 text-sm text-[#0ea5e9] hover:underline">
            ...
            <>
              ...
              {/* Mode toggle */}
              <div className="flex rounded-lg border border-[#2d2d2d] mb-5 overflow-hidden">
                <button
                  onClick={() => setMode('password')}
                  className={`flex-1 py-2 text-sm transition-colors ${mode === 'password' ? 'bg-[#0ea5e9] text-white' : 'text-[#b3b3b3] hover:text-white'}`}
                >
                  Password
                </button>
                <button
                  onClick={() => setMode('magic')}
                  className={`flex-1 py-2 text-sm transition-colors ${mode === 'magic' ? 'bg-[#0ea5e9] text-white' : 'text-[#b3b3b3] hover:text-white'}`}
                >
                  Magic Link
                </button>
              </div>
              ...
              {error && (
                <div className="mb-4 px-4 py-3 rounded-lg bg-[#e11d48]/10 border border-[#e11d48]/20 text-[#e11d48] text-sm">
                  {error}
                </div>
              )}
                ...
                {mode === 'password' && (
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <button type="button" onClick={() => setMode('magic')} className="text-xs text-[#0ea5e9] hover:underline">
                        Forgot password?
                      </button>
                    </div>
                    <input
